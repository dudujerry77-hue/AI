...
export class InitializationError extends RuntimeError {
  constructor(message: string, options: RuntimeErrorOptions = {}) {
    super(message, {
      ...options,
      code: options.code ?? 'runtime.initialization_error',
    });
...
export class ConfigurationError extends RuntimeError {
  constructor(message: string, options: RuntimeErrorOptions = {}) {
    super(message, {
      ...options,
      code: options.code ?? 'runtime.configuration_error',
    });
...
export class ShutdownError extends RuntimeError {
  constructor(message: string, options: RuntimeErrorOptions = {}) {
    super(message, {
      ...options,
      code: options.code ?? 'runtime.shutdown_error',
    });
...
export class EventBusError extends RuntimeError {
  constructor(message: string, options: RuntimeErrorOptions = {}) {
    super(message, {
      ...options,
      code: options.code ?? 'runtime.event_bus_error',
    });
...
export class HealthCheckError extends RuntimeError {
  constructor(message: string, options: RuntimeErrorOptions = {}) {
    super(message, {
      ...options,
      code: options.code ?? 'runtime.health_check_error',
    });
...
export class MetricsError extends RuntimeError {
  constructor(message: string, options: RuntimeErrorOptions = {}) {
    super(message, {
      ...options,
      code: options.code ?? 'runtime.metrics_error',
    });
